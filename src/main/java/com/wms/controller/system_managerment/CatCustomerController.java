...
public class CatCustomerController extends BaseCommonController{
    ...
    public  @ResponseBody List<CatCustomerDTO> findByCondition(@RequestParam("status")String status, @RequestParam("keyword")String keyword){
    ...
    public @ResponseBody String update(CatCustomerDTO catCustomerDTO, HttpServletRequest request){
    ...
    public @ResponseBody  String add(CatCustomerDTO catCustomerDTO, HttpServletRequest request){
        catCustomerDTO.setStatus("1");
